...
def is_search_over_papers(question: str) -> bool:
    ...
    Returns:
        bool: True if the question is about searching over papers, False otherwise.
    """
    # Define keywords that indicate the question is about papers
    ...
    try:
        ...
        if answer.startswith('yes'):
            ...
            return False
        # If the answer is not clear, fall back to keyword matching
...
def search_basic(question: str) -> str:
    """
    Calls the LLM to get an answer to the question, targeting an educational or scientific user.
        ...
        for criterion in items.keys():
            if intersected_candidates == set():
                ...
                if criterion not in candidates:
                    print(f"Warning: No candidates found for criterion '{criterion}'")
                    continue
...
def is_relevant_answer_with_data(question: str, answer: str) -> bool:
    """
    Uses the analysis_llm to determine if the answer responds to the question with a list of resources.
    ...
    Returns:
        bool: True if the answer contains a relevant list of resources, False otherwise.
    """
    ...
    try:
        ...
        print(f"Error in is_relevant_answer_with_data: {e}")
        return False